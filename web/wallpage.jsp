<%-- 
    Document   : wallpage
    Created on : May 11, 2017, 6:05:25 PM
    Author     : KGRS
--%>
            ...
            <div class="header">
                ...
                <div id="menu-wrapper">
                    <div id="menu" class="menu">
                        <ul id="tiny">
                            <li class="active"><a href="index.html">User pic</a>

                            </li>
                            <li><a href="page-with-sidebar.html">user name</a>
                            ...
                            <li>
                                <div>
                                    <div class="nav navbar-nav">
                                        <button onclick="location.href = 'index.html';" style="width:auto;">Log Out</button>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div>
                                    <div class="nav navbar-nav">
                                        <button onclick="location.href = 'singup.html';" style="width:auto;">Edit...</button>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="post format-image box"> 
                    ...
                    <table>
                        ...
                        <div id="id01" class="modal">
                            <form class="modal-content animate" action="AddPost">
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td><label><b><div class="container1" style="background-color:#ffff">
                                                        <button onclick="location.href = 'wallpage.html';" type="submit" >Post</button>
                                                    </div></b></label>
                                        </td>
                                        <td>    						</td>
